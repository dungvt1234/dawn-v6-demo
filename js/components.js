...
<header id="site-header" class="fixed top-0 left-0 right-0 z-50 transition-all duration-500 h-[90px] flex items-center" style="background:var(--ivory);">
 <div class="max-w-container w-full mx-auto px-6 md:px-12 flex items-center justify-between">
  ...
  <nav class="hidden xl:flex items-center gap-6 xl:ml-8">
   ${navLinks}
  </nav>
  <a href="${DEMO_URL}" target="_blank" rel="noopener" class="hidden xl:inline-flex items-center gap-2 ml-6 px-5 py-2.5 rounded-full text-[12px] font-bold tracking-[0.08em] uppercase transition-all duration-300 hover:-translate-y-0.5 focus-ring" style="background:var(--chartreuse); color:var(--forest); box-shadow:0 4px 14px rgba(0,0,0,.12);">🖥️ Dùng thử phần mềm</a>
  ...
  <button id="menu-btn" class="xl:hidden p-2 text-forest focus:outline-none focus-ring" aria-label="Mở menu">
   <i data-lucide="menu" class="w-7 h-7"></i>
  </button>
 </div>
</header>
<div id="mobile-menu" class="hidden fixed top-[90px] left-0 right-0 bottom-0 bg-ivory border-b border-forest/10 p-6 flex-col gap-4 shadow-2xl xl:hidden overflow-y-auto overscroll-contain z-[100]" style="-webkit-overflow-scrolling:touch;">
  ${mobileLinks}
...
<div id="floating-contact" class="fixed bottom-6 right-5 md:bottom-8 md:right-8 z-[60] flex flex-col items-end" style="position:fixed;bottom:24px;right:20px;z-index:60;display:flex;flex-direction:column;align-items:flex-end;">
 <div id="fc-links" class="flex flex-col items-end gap-3 mb-3 opacity-0 invisible translate-y-3 transition-all duration-300 ease-out">
  <button type="button" id="fc-chat" class="fc-btn flex items-center gap-2.5 bg-white rounded-full pl-2 pr-4 py-2 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5 focus-ring" style="background:#fff;border:none;cursor:pointer;">
   <span class="fc-icon w-9 h-9 rounded-full flex items-center justify-center text-lg" style="background:#DCD870;">🌱</span>
   <span class="text-[13px] font-semibold text-charcoal">Chat tư vấn</span>
  </button>
  <a href="${DEMO_URL}" target="_blank" rel="noopener" class="fc-btn flex items-center gap-2.5 bg-white rounded-full pl-2 pr-4 py-2 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5 focus-ring" style="background:#fff;">
   <span class="fc-icon w-9 h-9 rounded-full flex items-center justify-center text-forest font-bold text-lg" style="background:#DCD870;">🖥️</span>
  ...
  <a href="tel:0866685632" class="fc-btn flex items-center gap-2.5 bg-white rounded-full pl-2 pr-4 py-2 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5 focus-ring">
   <span class="fc-icon w-9 h-9 rounded-full flex items-center justify-center text-white" style="background:#223D22;"><i data-lucide="phone" class="w-4.5 h-4.5"></i></span>
   <span class="text-[13px] font-semibold text-charcoal">0866 685 632</span>
  </a>
 </div>
 <button id="fc-toggle" aria-label="Liên hệ nhanh" aria-expanded="false" class="w-14 h-14 md:w-16 md:h-16 rounded-full flex items-center justify-center shadow-xl transition-all duration-300 hover:scale-105 focus-ring" style="background:#DCD870;color:#223D22;">
